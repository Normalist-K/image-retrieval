...
# Directory for Log
LOG_DIR = args.LOG_DIR + f'/logs_dolg/{date_time.day}.{date_time.hour}h{date_time.minute}m-{args.remark}'
...
# Train Parameters
if args.model in ['dolg', 'cgdolg', 'cgdolg2']:
